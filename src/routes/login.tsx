...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Sign in — Atelier Pro" },
      { name: "description", content: "Sign in to your Atelier Pro student account." },
    ],
  }),
  component: LoginPage,
});
    ...
    <SiteShell>
      <section className="container-luxe py-32">
        <div className="mx-auto max-w-md">
          <h1 className="font-display text-4xl text-foreground">{t("auth.login.title")}</h1>
          ...
          <button
            ...
            onClick={onGoogle}
            disabled={busy}
            className="mt-8 flex w-full items-center justify-center gap-3 rounded-md border border-border bg-background px-4 py-3 text-sm font-medium hover:bg-muted/40 transition disabled:opacity-50"
          >
